                ...
                <div className="single-page-header-inner">
                  <div className="left-side">
                    ...
                    <div className="header-details">
                      <h3>{Heroe.nombre} {Heroe.apellidoPaterno} {Heroe.apellidoMaterno} <span>{Heroe.titulo}</span></h3>
                      <ul>
          ...
          <div className="row">
            ...
            <div className="col-xl-4 col-lg-4">
              <div className="sidebar-container">
                ...
                <div className="profile-overview">
                  <div className="overview-item"><span>Estudios:</span><strong>{Heroe.estudios}</strong></div>
